...
namespace SimpleMapper
{
    public class Repository<T> where T:new()
    {
        ...
        public Repository(string connectionString,DbContext context)
        {
            this.connectionString = connectionString;
            mapper = new AbstractMapper(connectionString);
            mapper.isStronglyTyped = true;
    ...
    public class NonRepository
    {
        private AbstractMapper mapper;
        private QueryTranslator translator;
        public NonRepository(string connectionString)
        {
            mapper = new AbstractMapper(connectionString);
            mapper.isStronglyTyped = false;
            translator = new QueryTranslator();
        }
        public NonRepository(string connectionString, DbContext context)
        {
            mapper = new AbstractMapper(connectionString);
            mapper.isStronglyTyped = false;
            mapper.RegisterDbContext(context);
